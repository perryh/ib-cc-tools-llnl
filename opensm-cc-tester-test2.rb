...
averages = Array.new
result_file.puts "conf_file,marking_rate,ccti_timer,send_37,send_38,send_39,send_40,send_43,send_44,receive_41,receive_42"
result_file.close
Dir.foreach($dir) do |conf|
	...
	retval = `sh congest_test2.sh | grep -E "\[R\]|\[W\]"`
