...
if(ARGV[0].to_s == "")
	fail("Usage: ./opensm-cc-tester-test4.rb [dir]")
end
...
averages = Array.new
result_file.puts "conf_file,send_37,send_38,send_39,send_43,receive_41,receive_42"
result_file.close
Dir.foreach($dir) do |conf|
	...
	retval = `sh congest_test4.sh | grep -E "\[R\]|\[W\]"`
	...
	result_file.puts "#{conf},#{send_37},#{send_38},#{send_39},#{send_43},#{receive_41},#{receive_42}"
